...
AodvEjemplo::Ejecutar ()
{
    ...
    flowMonitor->SerializeToXmlFile("graphs/TCP/prueba/flowMonNodes.xml", true, true);
}
...
AodvEjemplo::CrearNodos ()
{
    ...
    std::string traceFile = "src/mobility/examples/ut100.ns_movements";
...
AodvEjemplo::CrearDispositivos ()
{
    ...
    if (pcap)
    {
        ...
        wifiPhy.EnablePcapAll ("graphs/TCP/prueba/aodv-ipv6");
...
AodvEjemplo::InstalarProtocolos ()
{
    ...
    if (imprimirRutas)
    {
        Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper> ("graphs/TCP/prueba/aodv-ipv6.rutas", std::ios::out);
